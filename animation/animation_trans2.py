'''animation_trans2.py   将PNG格式图片单一背景颜色转换为透明   2022.11.18
在animation_trans1.py增加绘画窗口坐标线的函数coordinate(),更好理解背景透明效果.
坐标线在窗口最上层或底层效果是有区别,与绘图的先后秩序相关,
见本程序注释后带 ** 的语句,选其一.
...
if __name__ == "__main__":   # execute only if run as a script
    ...
    pygame.display.set_caption('Animation_Transparent  example 2 ') # 设置游戏窗口的标题
