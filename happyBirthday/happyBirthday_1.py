'''happyBirthday_1.py   2022.7.6
在窗口中由用户按下4个方向(上下左右)键进行精灵(boss)移动,接受下落的礼物.
接受到礼物则加记1分,如果礼物下落出窗口底部则减记1分.
当总分到达6分时,将有圣诞老人空降新加坡给你带来祝福.
本例用pygame编写的生日祝福,游戏编程最基本的入门结构,我会在后期优化:
...
text1 = fon1.render("Score: {} ".format(score),True,(18,255,88)) # text1是Surface对象
text = "Hi YiChen.    Happy birthday!    Grandpa and grandma love you!"
text2 = fon2.render(text,True,'pink') # text2是Surface对象
...
while game_on:
    ...
    if newGiftRect.top >= height:
        ...
        text1 = fon1.render("Score: {} ".format(score),True,(18,255,88))
