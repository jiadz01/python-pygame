'''happyBirthday_8.py    对happyBirthday_7.py修改   2022.9.17
程序结构改建成由2个游戏部份主循环函数,再由程序主函数调用的方式,更规范易阅读.
...
def game_1 ():
  ...
  global giftNumber,giftGenerateTime,choice,text1,text1Rect,score
